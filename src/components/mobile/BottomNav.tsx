import { Home, Search, Settings, FileVideo, Languages } from "lucide-react";
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={cn(
                "flex flex-col items-center justify-center gap-1 px-4 py-2 rounded-lg transition-all duration-200 min-w-[4rem]",
                isActive
